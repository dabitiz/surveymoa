import { n as noop, a as assign, i as identity, s as subscribe, b as null_to_empty } from "../../chunks/utils.js";
import { c as create_ssr_component, o as onDestroy, v as validate_component, m as missing_component, a as add_attribute, e as each, b as escape } from "../../chunks/ssr.js";
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${``} ${$loading || $navigating || !is_initialize ? `<div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50" data-svelte-h="svelte-9f7a7s"><div class="h-12 w-12 animate-spin rounded-full border-b-2 border-t-2 border-primary"></div></div>` : ``} <div class="wrap svelte-1a3h13x">${validate_component(SvelteToast, "SvelteToast").$$render(
    $$result,
    {
      options: {
        intro: { y: -64 },
