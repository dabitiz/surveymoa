 ...
 * AG-GRID
 ******************************************************************/
// import {g_nvl, uc} from "../common/hebees_common";
 ...
 * AG-GRID 한국 날짜 변환
 * @param {*} params
 * ex. { headerName: "", field: "", valueFormatter: date_formatter },
 */
export const date_formatter = (params) => {
	if (params.value === null) return "";

	return new Date(params.value).toLocaleDateString("ko", {
		weekday: "long",
		year: "numeric",
		month: "short",
		day: "numeric",
