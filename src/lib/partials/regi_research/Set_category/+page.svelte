...
<div class="mx-5 flex flex-col">
	...
	<button
		on:click={() => {
			category = category === "설문조사" ? "" : "설문조사";
		}}
		class={`mt-10 flex h-20 items-center rounded-lg bg-${category === "설문조사" ? "primary" : "gray-50"}  pl-6`}
	>
		<svg
			class="mr-5"
			width="22"
		...
		>
			<path
				...
				fill={category === "설문조사" ? "white" : colors.gray[900]}
			/>
		</svg>
		<div
			class={`flex flex-grow flex-col items-start gap-2 text-${category === "설문조사" ? "white" : "gray-900"}`}
		>
